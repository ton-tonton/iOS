...
@interface TONAppDelegate () <UIScrollViewDelegate>

@property (nonatomic, strong) TONHypnosisView *hypnosisView;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.hypnosisView = [[TONHypnosisView alloc] initWithFrame:screenRect];
