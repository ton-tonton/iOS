...
+(void)initialize
{
    ...
    NSDictionary *factorySetting = @{
                                      TONNextItemValuePrefsKey: @75,
                                      TONNextItemNamePrefsKey: @"CoffeeCup"
                                    };
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    if (!self.window.rootViewController) {
        ...
        TONItemsViewController *itemsViewController = [[TONItemsViewController alloc] init];
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    BOOL success = [[TONItemStore sharedStore] saveChanges];
